# Pipecat Multi-Channel Audio Transport

This implementation provides multi-channel audio output support for the agent service, enabling dual speaker setups with echo cancellation through configurable per-channel delays.
...
├── backend.py                       # Main PipecatBackend
