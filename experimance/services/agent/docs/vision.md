...
This document describes the vision processing capabilities of the agent service, including webcam capture, audience detection, and Vision Language Model (VLM) analysis.
...
The vision system includes camera analysis and optimization tools. Use these to get the best performance from your webcam:
...
For Reolink IP camera setup and usage, see `services/agent/docs/reolink.md`.
